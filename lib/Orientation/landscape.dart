...
landscape(BuildContext context, String expression, String answer,
                ...
                itemBuilder: (BuildContext context, int index) {
                  if (index == 0) {
                    return Button(const Color.fromARGB(255, 93, 204, 23),
                        buttontxt[index], Colors.white, index, 5.0);
                  }
                  if (index == 1) {
                    return Button(
                        Colors.red, buttontxt[index], Colors.white, index, 5.0);
                  }
                  if (index == 4 ||
                      index == 5 ||
                      index == 6 ||
                    ...
                    return Button(Colors.white, buttontxt[index],
                        const Color.fromARGB(255, 3, 183, 255), index, 5.0);
                  }
